			...
			if (objects[i].id != id)
			{
				...
				else
				{
					...
					case (uint8)ObjectClass::Player:
					{
						...
						{
							online_pawn_instance->Update(position, rotation, objects[i].velocity[0], objects[i].velocity[1], objects[i].grounded, objects[i].health, objects[i].ads, objects[i].crouching);
